...
public class PortfolioManagerFactory {
  ...
  public static PortfolioManager getPortfolioManager(RestTemplate restTemplate) {
    PortfolioManager a = new PortfolioManagerImpl(restTemplate);


     return a;
  }
  // public static PortfolioManager getPortfolioManager(StockQuotesService  stockQuotesService ){
  //   PortfolioManager b = new PortfolioManagerImpl(stockQuotesService);
  //   return b;
  ...
  //       ./gradlew test --tests PortfolioManagerFactory
   ...
   public static PortfolioManager getPortfolioManager(String provider,
     RestTemplate restTemplate) {
      StockQuotesService a = StockQuoteServiceFactory.INSTANCE.getService(provider, restTemplate);
      return new PortfolioManagerImpl(a);
   }
